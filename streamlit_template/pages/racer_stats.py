...
df_racer = pd.read_csv('data/racer_stats.csv') # Import data file
# st.write(df_racer) # Writes stats from data file

# Styling and altering the data frame
...
left_column_1, right_columnn_1 = st.columns(2)
